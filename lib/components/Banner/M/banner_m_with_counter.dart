        ...
        Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                BlurContainer(
                  child: Text(_duration.inHours.toString().padLeft(2, "0"),
...
// Suggested code may be subject to a license. Learn more: ~LicenseLog:1646345397.
class BlurContainerText extends StatelessWidget {
  const BlurContainerText({
    super.key,
    required this.text,
  });
  final String text;
